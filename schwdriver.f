      PROGRAM SCHWDRIVER
C   THIS PROGRAM DRIVES DSCPACK. IT CALCULATES THE PARAMETERS OF THE
C   DOUBLY-CONNECTED SCHWARZ-CHRISTOFFEL (DSC) MAP W(Z) FROM A PAIR OF SLLITS
C   ON A PLANE ARRANGED ON THE REAL LINE IN AN INVERSION-SYMMETRIC
C   FASHION TO AN ANNULUS. THE POSITIONS OF THE SLITS ARE IN THE ARRAYS
C   Z0,Z!.
C
C   IT OUTPUTS THE DERIVATIVES OF THE DSC MAP W'(Z) AS WELL AS THE
C   DERIVATIVE OF THE MAP FROM THE FINITE CYLINDER TO THE INFINITE SLIT
C   CYLINDER S'(ZETA) USED IN THE MAIN CALCULATION.
C
C
C
C     .. Scalars in Common ..
